...
const AllSeller = () => {
    ...
    return (
        <div className='dark:bg-gray-900  dark:text-white'>
            <p className='text-center py-4 font-bold text-4xl'>This is All Seller page</p>
                        ...
                        <tbody>
                            ...
                            {data && data.map((seller, index) => <tr key={seller._id} className="hover">
                                ...
                                <td>
                                    ...
                                    <p className='flex items-center gap-4'>Verify: {seller?.sellerVerify ? <GoVerified className='text-blue-600' /> : ""} </p>
