        ...
        <div className="m-0 py-16  md:px-24 lg:px-8 lg:py-20 bg-base-100 dark:bg-gray-900 text-gray-800  dark:text-white">
            <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
                <div className="lg:w-1/2">
                    <h2 className="max-w-md mb-6 font-sans text-3xl font-bold tracking-tight  sm:text-4xl sm:leading-none xl:max-w-lg">
                        To Buy and Sells You Should be Be Alert .
                    </h2>
                </div>
                <div className="lg:w-1/2">
                    <p className="text-base  md:text-lg text-justify">
                        <strong className=' text-orange-400'>Machineries-Sells says...</strong> In our planet. There have many good people and also have many bad people. So Judge the people by technic and be honest, You may follow ours rolls if you want.
                    </p>
                </div>
            </div>
            <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
                <div>
                    ...
                    <h6 className="mb-2 font-semibold leading-5">Well Behave</h6>
                    <p className="mb-3 text-sm text-gray-900">
                        We choose to well behave customers and sellers that the 1st priority to show.
                    </p>
                ...
                <div>
                    ...
                    <h6 className="mb-2 font-semibold leading-5">Another Way</h6>
                    <p className="mb-3 text-sm text-gray-900">
                        There can be A BLUE tick sign if sellers verify or not. Its Helps you a lot.
                    </p>
                    <ul className="mb-4 -ml-1 space-y-2">
                        <li className="flex items-start">
                            <span className="mr-1">
                ...
                <div>
                    ...
                    <h6 className="mb-2 font-semibold leading-5">Explore Places</h6>
                    <p className="mb-3 text-sm text-gray-900">
                        We are Provided to explore the sellers exact location.
                    </p>
                    <ul className="mb-4 -ml-1 space-y-2">
                        <li className="flex items-start">
                            <span className="mr-1">
                ...
                <div>
                    ...
                    <h6 className="mb-2 font-semibold leading-5">Be Aware</h6>
                    <p className="mb-3 text-sm text-gray-900">
                        Be Aware and make sure if seller is verified. Otherwise discourage the sellers.
                    </p>
                    <ul className="mb-4 -ml-1 space-y-2">
                        <li className="flex items-start">
                            <span className="mr-1">
